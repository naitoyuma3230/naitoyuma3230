### 理学療法士からプログラマー 
 ...
 次のステップとして医療・介護やヘルスケア、スポーツといった領域において、前職の専門性とITを組み合わせた仕事がしたいと考えています。
...
### フロントエンドエンジニア
ご縁を頂き東証プライム上場のIT企業にプログラマーとして就職しました。医療、介護に関するシステム開発をしている会社です。私はフロントエンドでJavascriptのフレームワークであるjQueryやVueを使用しています。
